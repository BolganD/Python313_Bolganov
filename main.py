...
#
#         if country in data:
#             print(f'Страна {country.capitalize()} столица {data[country].capitalize()} есть в '
#                   f'словаре')
#
#         else:
...
#         country = input('Введите страну для изменения: ').lower()
...
# # print(top_users)  # [(5, 12), (10, 12), (1, 11), (8, 11), (7, 9), (2, 8), (9, 8),
# # # (3, 7), (4, 6), (6, 6)]
...
#     writer.writerow({"Имя": "Даша", 'Возраст': 9})
...
#     cur = con.cursor()
    ...
    # id INTEGER PRIMARY KEY AUTOINCREMENT,
    # name TEXT NOT NULL,
    # phone BLOB NOT NULL DEFAULT "+79510000000",
...
#     """)
    ...
    # cur.execute("UPDATE cars SET price = :Price WHERE model LIKE 'B%'", {'Price': 1000})

    # for car in cars_tpl:
    #     cur.execute('INSERT INTO cars VALUES(NULL, ?, ?)', car)

    # cur.execute("INSERT INTO cars VALUES(1, 'Renault', 22000)")
    # cur.execute("INSERT INTO cars VALUES(2, 'Volvo', 22000)")
